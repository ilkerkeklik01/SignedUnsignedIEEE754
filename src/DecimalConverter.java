...
public class DecimalConverter {
    ...
    static double binaryTo1ByteFloatingPoint(String binaryString,int numOfBytes) throws InfinityException, NaNException {
        ...
        //Byte sayısına göre değişecek şekilde ayarlaman gerek..
        //special
            ...
            if(fractionField.length()>13){
                ...
                //infinity
                if(!fr.contains("1")){//ilk 13 full 0 sa

                    //14. 1 ise
                    if(fractionField.charAt(13)=='1'){

                        //14. 1 se ve greater than half way ise 00000...1 NaN
                    ...
                    }//ilk 13 0 ve 14. 0 ise    000000..00 infinity
                    else{
                        throw new InfinityException("Infinity");
                    }

                }
                //NaN //ilk 13 0 1 li ise
                else{
                    throw new NaNException("NaN");
                }
            ...
            }else{// rounda gerek yoksa
                //hepsi 0 sa infinity değilse NaN
